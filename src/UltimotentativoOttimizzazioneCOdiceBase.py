...
def genera_clusters(coords, n_clusters=100, random_state=0):
...
if __name__ == '__main__':
    ...
    #carico il modello
    model_name = "ResNet50DvsC.h5"
   
    loaded_model = tf.keras.models.load_model("C:/Users/Dell/Desktop/partefinalwe/ResNet50DvsC.h5")
    ...
    for i in range(301,499,1):#dim_campioni
        numeroscelto=i    
       ...
       # plt.show()
        ...
        plt.savefig("C:/Users/Dell/Desktop/CaniVsDOgghi/Basic/Input{}.png".format(numeroscelto))
        plt.close()
    ...
    # Ordina gli elementi in base alla coordinata x (prima colonna) e poi y (seconda colonna)
        ...
        matrix_expanded = np.stack((matrix_224x224, matrix_224x224, matrix_224x224), axis=-1) 
       # matrix_expanded = np.stack((matrix, matrix, matrix), axis=-1) 
        ...
        plt.imshow(new_im)  
        plt.savefig("C:/Users/Dell/Desktop/CaniVsDOgghi/newtry/CLustpiuImm/inp{}.png".format(numeroscelto))
    #    plt.show()
        plt.close()
        #---------------------------------------------------------------------------------------------------------------------------------#-----------------------------------------------------------------------------------------------------------------------------------
    ...
    # Stampa del miglior pixel selezionato 
        ...
        # Stampa del miglior pixel selezionato
            ...
            print(image_label_arr)
            #plt.show()
            plt.savefig("C:/Users/Dell/Desktop/CaniVsDOgghi/newtry/imgmod/immaginemodificata{}.png".format(numeroscelto))
    ...
    nome_file_excel='C:/Users/Dell/Desktop/CaniVsDOgghi/newtry/Campioni301-500.xlsx'
